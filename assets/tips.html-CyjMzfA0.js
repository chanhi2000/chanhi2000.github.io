import{_ as u}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as v,d as n,at as p,b as t,t as b,w as a,r as o,o as k,e as s}from"./app-CQPSjWsH.js";const g={},y={id:"frontmatter-title-관련",tabindex:"-1"},f={class:"header-anchor",href:"#frontmatter-title-관련"},x={class:"table-of-contents"};function h(d,e){const l=o("router-link"),m=o("Tabs"),r=o("TagLinks");return k(),v("div",null,[n("h1",y,[n("a",f,[n("span",null,b(d.$frontmatter.title)+" 관련",1)])]),n("nav",x,[n("ul",null,[n("li",null,[t(l,{to:"#uname"},{default:a(()=>e[0]||(e[0]=[s("uname")])),_:1})]),n("li",null,[t(l,{to:"#dmidecode-cpu-memory-정보"},{default:a(()=>e[1]||(e[1]=[s("dmidecode CPU/Memory 정보")])),_:1})]),n("li",null,[t(l,{to:"#df-디스크-정보"},{default:a(()=>e[2]||(e[2]=[s("df 디스크 정보")])),_:1})]),n("li",null,[t(l,{to:"#ethtool-네트워크-정보"},{default:a(()=>e[3]||(e[3]=[s("ethtool 네트워크 정보")])),_:1})]),n("li",null,[t(l,{to:"#reduce-swappiness-optimize-swap-usage"},{default:a(()=>e[4]||(e[4]=[s("Reduce Swappiness (Optimize Swap Usage)")])),_:1})])])]),e[9]||(e[9]=p(`<h2 id="uname" tabindex="-1"><a class="header-anchor" href="#uname"><span><code>uname</code></span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">uname</span>       <span class="token comment"># 옵션이 없을 경우, -s 옵션을 사용하는 것과 동일 (i.e. 커널 이름 출력)</span></span>
