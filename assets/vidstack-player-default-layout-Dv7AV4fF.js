const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-CmqqnRgc-CJaAhBZw.js","assets/app-zziFtMdd.js"])))=>i.map(i=>d[i]);
var we=Object.getPrototypeOf;var ke=Reflect.get;var lt=(e,t,s)=>ke(we(e),s,t);import{a4 as b,a5 as Et,a6 as V,a7 as Ce,a8 as G,a9 as S,aa as Vt,ab as C,ac as Ae,ad as De,ae as Me,af as x,ag as Wt,ah as Oe,ai as F,aj as h,ak as W,_ as Ie,al as Pe,am as Ht,an as Kt,ao as _e,ap as Ge,aq as Qt,ar as z,as as $t,at as Ne,au as zt,av as Be,aw as Le,ax as Fe,ay as O,az as Re,aA as Ee,aB as Ut,aC as rt,aD as Ve,aE as We,aF as He,aG as Ke,aH as jt}from"./app-zziFtMdd.js";import{A as I,T as Qe,D as Nt,x as l,s as ze,$ as Ue,L as qt}from"./vidstack-D2YigfqZ-BLArkuQb.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const U={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},X=e=>(...t)=>({_$litDirective$:e,values:t});let gt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let pt=class extends gt{constructor(t){if(super(t),this.et=I,t.type!==U.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===I||t==null)return this.ft=void 0,this.et=t;if(t===Qe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const s=[t];return s.raw=s,this.ft={_$litType$:this.constructor.resultType,strings:s,values:[]}}};pt.directiveName="unsafeHTML",pt.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const R=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const o of i)(n=(s=o)._$AO)===null||n===void 0||n.call(s,t,!1),R(o,t);return!0},j=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},Zt=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),ts(t)}};function Xe(e){this._$AN!==void 0?(j(this),this._$AM=e,Zt(this)):this._$AM=e}function Je(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let o=s;o<n.length;o++)R(n[o],!1),j(n[o]);else n!=null&&(R(n,!1),j(n));else R(this,e)}const ts=e=>{var t,s,n,i;e.type==U.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Je),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Xe))};class Yt extends gt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Zt(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(R(this,t),j(this))}setValue(t){if(qe(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class es extends Yt{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===U.ATTRIBUTE||t.type===U.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Vt(this.h)):I}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?bt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function a(e){return X(es)(b(e))}class Xt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=Et(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});V(()=>t.disconnect()),V(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){Ce(t)?(s.textContent="",s.append(t)):(Nt(null,s),Nt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}Ha(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=this._m.flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&this.La(this.elements)}}let ss=0,Q="data-slot-id";class Jt{constructor(t){this._m=t,this.Gc=Et(this.Ha.bind(this)),this.slots=new Xt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});V(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(Q);i||s.setAttribute(Q,i=++ss+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==n||o.getAttribute(Q)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,o),o.setAttribute(Q,i)}}}}function ns({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return l`<svg
    class="${"vds-icon"+(t?` ${t}`:"")}"
    viewBox="${i}"
    fill="none"
    aria-hidden="true"
  ...
  `}function ae(){const{translations:e}=d(),{live:t}=h(),s=u(e,"Skip To Live"),n=u(e,"LIVE");return t()?l`
      ...
      `:null}function St(){return a(()=>{const{download:e,translations:t}=d(),s=e();if(_e(s))return null;const{source:n,title:i}=h(),o=n(),r=Ge({title:i(),src:o,download:s});return r?l`
  ...
  `}function D({label:e,option:t,type:s}){const{player:n}=S(),{translations:i}=d(),o=P[s],r=()=>T(i,e);function p(){Ee(),n.dispatchEvent(new Event("vds-font-change"))}if(t.type==="color"){let v=function(m){o.set(m.target.value),p()};return K({label:a(r),children:l`
        <input
  ...
  `}function Ns(){return a(()=>{const{translations:e}=d();return l`
    ...
    `})}function Rs(){return a(()=>{const{translations:e}=d(),{audioTracks:t}=h(),s=u(e,"Default");return b(()=>t().length<=1)()?null:k({children:l`
      ...
      `})})}function Es(){return a(()=>{const{noAudioGain:e,translations:t}=d(),{canSetAudioGain:s}=h();if(b(()=>!s()||e())())return null;const{audioGain:i}=h();return k({label:u(t,"Boost"),value:a(()=>Math.round(((i()??1)-1)*100)+"%"),children:[nt({upIcon:"menu-audio-boost-up",downIcon:"menu-audio-boost-down",children:Vs(),isMin:()=>((i()??1)-1)*100<=de(),isMax:()=>((i()??1)-1)*100===ue()})]})})}function Vs(){const{translations:e}=d(),t=u(e,"Boost"),s=de,n=ue,i=Ws;return l`
  ...
  `}function me({placement:e,portal:t,tooltip:s}){return a(()=>{const{viewType:n}=h(),{translations:i,menuPortal:o,noModal:r,menuGroup:p,smallWhen:c}=d(),$=b(()=>r()?z(e):c()?null:z(e)),v=b(()=>!c()&&p()==="bottom"&&n()==="video"?26:0),m=x(!1);fs();function f(){m.set(!0)}function g(){m.set(!1)}const y=l`
    ...
    `})}function At({orientation:e,tooltip:t}){return a(()=>{const{pointer:s,muted:n,canSetVolume:i}=h();if(s()==="coarse"&&!n())return null;if(!i())return Bt({tooltip:t});const o=x(void 0),r=Ne(o);return l`
  ...
  `}function Dt(){const e=x(void 0),t=x(0),{thumbnails:s,translations:n,sliderChaptersMinWidth:i,disableTimeSlider:o,seekStep:r,noScrubGesture:p}=d(),c=u(n,"Seek"),$=a(o),v=a(()=>t()<i()),m=a(s);return zt(e,()=>{const f=e();f&&t.set(f.clientWidth)}),l`
    <media-time-slider
  ...
  `}function tn(){return a(()=>{const{live:e,duration:t}=h();return e()?ae():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function ve(){return a(()=>{const{live:e}=h();return e()?ae():Js()})}function fe(){return a(()=>{const{textTracks:e}=S(),{title:t,started:s}=h(),n=x(null);return Qt(e,"chapters",n.set),n()&&(s()||!t())?he():l`<media-title class="vds-chapter-title"></media-title>`})}function he(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class $e extends as{async Pf(){const t=(await Ie(async()=>{const{icons:n}=await import("./vidstack-CmqqnRgc-CJaAhBZw.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=ns({name:n,paths:t[n]});return s}}var M;let en=(M=class extends N{},M.props={...lt(M,M,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},M);function sn(){return[yt(),wt(),l`
    ...
    `]}function nn(){return a(()=>{let e=x(void 0),t=x(!1),s=S(),{title:n,started:i,currentTime:o,ended:r}=h(),{translations:p}=d(),c=We(e),$=()=>i()||o()>0;const v=()=>{const g=r()?"Replay":$()?"Continue":"Play";return`${T(p,g)}: ${n()}`};C(()=>{var g;c()&&document.activeElement===document.body&&((g=s.player.el)==null||g.focus())});function m(){const g=e(),y=!!g&&!c()&&g.clientWidth<g.children[0].clientWidth;g&&He(g,"vds-marquee",y),t.set(y)}function f(){return l`
      ...
      `}return zt(e,m),n()?l`
        ...
        `:A()})}function an(){const e="top end";return[re({tooltip:"top",placement:e,portal:!0}),me({tooltip:"top end",placement:e,portal:!0})]}const Z=class Z extends Ut(qt,en){constructor(){super(...arguments),this.en=x(!1)}onSetup(){this.forwardKeepAlive=!1,this.a=S(),this.classList.add("vds-audio-layout"),this.Fn()}onConnect(){se("audio",()=>this.isMatch),this.En()}render(){return a(this.Zm.bind(this))}Zm(){return this.isMatch?sn():null}En(){const{menuPortal:t}=d();C(()=>{if(!this.isMatch)return;const s=le(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),n=s?[this,s]:[this];return(this.$props.customIcons()?new Jt(n):new $e(n)).connect(),t.set(s),()=>{s.remove(),t.set(null)}})}Fn(){const{pointer:t}=this.a.$state;C(()=>{t()==="coarse"&&C(this.rn.bind(this))})}rn(){if(!this.en()){rt(this,"pointerdown",this.sn.bind(this),{capture:!0});return}rt(this,"pointerdown",t=>t.stopPropagation()),rt(window,"pointerdown",this.tn.bind(this))}sn(t){const{target:s}=t;Ve(s)&&s.closest(".vds-time-slider")&&(t.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),this.en.set(!0))}tn(){this.en.set(!1),this.removeAttribute("data-scrubbing")}};Z.tagName="media-audio-layout",Z.attrs={smallWhen:{converter(t){return t!=="never"&&!!t}}};let vt=Z;/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const on=X(class extends gt{constructor(){super(...arguments),this.key=I}render(e,t){return this.key=e,t}update(e,[t,s]){return t!==this.key&&(Ye(e),this.key=t),s}}),E=class E extends N{};E.props={...lt(E,E,"props"),when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380};let ft=E;function be(){return a(()=>{const e=S(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=d();if(b(()=>t()||!s())())return null;const i=x(!1),{lastKeyboardAction:o}=e.$state;C(()=>{i.set(!!o());const m=setTimeout(()=>i.set(!1),500);return()=>{i.set(!1),window.clearTimeout(m)}});const r=b(()=>{var f;const m=(f=o())==null?void 0:f.action;return m&&i()?W(m):null}),p=b(()=>`vds-kb-action${i()?"":" hidden"}`),c=b(ln),$=b(()=>{const m=rn();return m?Ke(m):null});function v(){const m=$();return m?l`
