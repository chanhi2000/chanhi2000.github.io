import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as r,d as s,t as d,b as a,h as l,ax as m,g as u,r as p,o as v,e as t}from"./app-CNfTDEV_.js";const b={},h={id:"frontmatter-title-관련",tabindex:"-1"},k={class:"header-anchor",href:"#frontmatter-title-관련"},g={class:"table-of-contents"};function f(i,n){const e=p("router-link"),o=p("TagLinks");return v(),r("div",null,[s("h1",h,[s("a",k,[s("span",null,d(i.$frontmatter.title)+" 관련",1)])]),s("nav",g,[s("ul",null,[s("li",null,[a(e,{to:"#구성"},{default:l(()=>n[0]||(n[0]=[t("구성")])),_:1})]),s("li",null,[a(e,{to:"#command-입력-형식"},{default:l(()=>n[1]||(n[1]=[t("Command 입력 형식")])),_:1}),s("ul",null,[s("li",null,[a(e,{to:"#adb-devices"},{default:l(()=>n[2]||(n[2]=[t("adb devices")])),_:1})]),s("li",null,[a(e,{to:"#s-option"},{default:l(()=>n[3]||(n[3]=[t("-s option")])),_:1})])])]),s("li",null,[a(e,{to:"#port-forwarding"},{default:l(()=>n[4]||(n[4]=[t("Port forwarding")])),_:1})]),s("li",null,[a(e,{to:"#script-s"},{default:l(()=>n[5]||(n[5]=[t("Script(s)")])),_:1})]),s("li",null,[a(e,{to:"#종합-리포트"},{default:l(()=>n[6]||(n[6]=[t("종합 리포트")])),_:1})]),s("li",null,[a(e,{to:"#로그"},{default:l(()=>n[7]||(n[7]=[t("로그")])),_:1})]),s("li",null,[a(e,{to:"#adb-shell"},{default:l(()=>n[8]||(n[8]=[t("adb shell")])),_:1})]),s("li",null,[a(e,{to:"#app-내부저장소-접근-확인"},{default:l(()=>n[9]||(n[9]=[t("App 내부저장소 접근 / 확인")])),_:1})]),s("li",null,[a(e,{to:"#pull"},{default:l(()=>n[10]||(n[10]=[t("pull")])),_:1})]),s("li",null,[a(e,{to:"#push"},{default:l(()=>n[11]||(n[11]=[t("push")])),_:1})])])]),n[12]||(n[12]=m(`<hr><h2 id="구성" tabindex="-1"><a class="header-anchor" href="#구성"><span>구성</span></a></h2><ul><li>client: development machine에서 동작. shell에서 client를 invocation해서 command 실행 가능. ADT, DDMS도 client</li><li>server: development machine의 background process이며, client와 daemon 사이에서의 communication을 관리</li><li>daemon: 각각의 device에서 동작하는 background process</li></ul><p>client를 시작하면, ADB server가 실행중인지 확인해서 실행중이지 않으면 server를 시작시킨다. server가 시작되면 TCP의 5037 port로 binding해서 adb client로부터의 command를 받아들이는데, 모든 client는 server와 communication 하기 위해 5037 port를 사용.</p><blockquote><p>실행파일 : <code>\${android_sdk_path}/tools/adb</code></p></blockquote><h2 id="command-입력-형식" tabindex="-1"><a class="header-anchor" href="#command-입력-형식"><span>Command 입력 형식</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">adb <span class="token punctuation">[</span>-d <span class="token operator">|</span> <span class="token parameter variable">-e</span> <span class="token operator">|</span> <span class="token parameter variable">-s</span> <span class="token operator">&lt;</span>serialNumber<span class="token operator">&gt;</span><span class="token punctuation">]</span> <span class="token operator">&lt;</span>command<span class="token operator">&gt;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="adb-devices" tabindex="-1"><a class="header-anchor" href="#adb-devices"><span><code>adb devices</code></span></a></h3><p>adb server와 연결된 device를 보여준다.</p><p>형식 : [serialNumber] [state]</p><ul><li><code>serialNumber</code> = type-consolePort (ex : emulator-5554)</li><li><code>state</code><ul><li>offline (device가 adb와 아직 연결되지 않았거나 응답이 없는 상태)</li><li>device (adb server와 연결된 상태)</li></ul></li></ul><h3 id="s-option" tabindex="-1"><a class="header-anchor" href="#s-option"><span><code>-s</code> option</span></a></h3><p>여러개의 device가 연결되어 있는 상태에서 특정 device에 command를 입력하고 싶을 때 사용</p><p>형식</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">adb <span class="token parameter variable">-s</span> <span class="token operator">&lt;</span>serialNumber<span class="token operator">&gt;</span> <span class="token operator">&lt;</span>command<span class="token operator">&gt;</span></span>
<span class="line"><span class="token comment"># ex : adb -s emulator-5554 install sample.apk</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="port-forwarding" tabindex="-1"><a class="header-anchor" href="#port-forwarding"><span>Port forwarding</span></a></h2><p>device의 port를 forwarding 하고 싶을 때 사용하는 명령</p><blockquote><p>ex : port 6100에서 7100으로 forwarding 하고 싶은 경우</p><blockquote><p><code>adb forward tcp:6100 tcp:7100</code></p></blockquote></blockquote><hr><h2 id="script-s" tabindex="-1"><a class="header-anchor" href="#script-s"><span>Script(s)</span></a></h2><h2 id="종합-리포트" tabindex="-1"><a class="header-anchor" href="#종합-리포트"><span>종합 리포트</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">adb dumpsys <span class="token operator">&lt;</span>service<span class="token operator">&gt;</span>       <span class="token comment"># app/service 상태정보 덤프, 서비스별로 추가 파라미터 받을 수 있음</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="로그" tabindex="-1"><a class="header-anchor" href="#로그"><span>로그</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">adb logcat <span class="token comment"># 로그캣 보기</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="adb-shell" tabindex="-1"><a class="header-anchor" href="#adb-shell"><span><code>adb shell</code></span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment">#</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="app-내부저장소-접근-확인" tabindex="-1"><a class="header-anchor" href="#app-내부저장소-접근-확인"><span>App 내부저장소 접근 / 확인</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">adb shell <span class="token builtin class-name">cd</span> /data/data/<span class="token punctuation">[</span>packageNm<span class="token punctuation">]</span> <span class="token comment"># 경로 이동</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>Copying files</p><h2 id="pull" tabindex="-1"><a class="header-anchor" href="#pull"><span><code>pull</code></span></a></h2><p>device에서 file을 copy해 올 때 사용 (recursively)</p><p><code>adb pull &lt;remote&gt; &lt;local&gt;</code></p><h2 id="push" tabindex="-1"><a class="header-anchor" href="#push"><span><code>push</code></span></a></h2><p>pull과 반대로 file을 device에 복사해 넣고 싶을 때 사용 (recursively)</p><p><code>adb push &lt;local&gt; &lt;remote&gt;</code></p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">adb push foo.txt /sdcard/foo.txt<span class="token punctuation">)</span> <span class="token punctuation">(</span>/sdcard/foo.txt 에서 /sdcard는 device에 존재하는 path</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,36)),u(` 
...
`),n[13]||(n[13]=s("hr",null,null,-1)),a(o)])}const P=c(b,[["render",f],["__file","adb.html.vue"]]),A=JSON.parse('{"path":"/programming/java-android/adb.html","title":"adb","lang":"ko-KR","frontmatter":{"lang":"ko-KR","title":"adb","description":"Android > adb","icon":"fas fa-terminal","category":["Android","adb"],"tag":["adb","android"],"head":[["meta",{"property":"og:url","content":"https://chanhi2000.github.io/programming/java-android/adb.html"}],["meta",{"property":"og:site_name","content":"chanhi2000"}],["meta",{"property":"og:title","content":"adb"}],["meta",{"property":"og:description","content":"Android > adb"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"ko-KR"}],["meta",{"property":"article:tag","content":"adb"}],["meta",{"property":"article:tag","content":"android"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"adb\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[{"level":2,"title":"구성","slug":"구성","link":"#구성","children":[]},{"level":2,"title":"Command 입력 형식","slug":"command-입력-형식","link":"#command-입력-형식","children":[{"level":3,"title":"adb devices","slug":"adb-devices","link":"#adb-devices","children":[]},{"level":3,"title":"-s option","slug":"s-option","link":"#s-option","children":[]}]},{"level":2,"title":"Port forwarding","slug":"port-forwarding","link":"#port-forwarding","children":[]},{"level":2,"title":"Script(s)","slug":"script-s","link":"#script-s","children":[]},{"level":2,"title":"종합 리포트","slug":"종합-리포트","link":"#종합-리포트","children":[]},{"level":2,"title":"로그","slug":"로그","link":"#로그","children":[]},{"level":2,"title":"adb shell","slug":"adb-shell","link":"#adb-shell","children":[]},{"level":2,"title":"App 내부저장소 접근 / 확인","slug":"app-내부저장소-접근-확인","link":"#app-내부저장소-접근-확인","children":[]},{"level":2,"title":"pull","slug":"pull","link":"#pull","children":[]},{"level":2,"title":"push","slug":"push","link":"#push","children":[]}],"git":{},"readingTime":{"minutes":2.8,"words":841},"filePathRelative":"programming/java-android/adb.md","excerpt":"\\n\\n<hr>\\n<h2>구성</h2>\\n<ul>\\n<li>client: development machine에서 동작. shell에서 client를 invocation해서 command 실행 가능. ADT, DDMS도 client</li>\\n<li>server: development machine의 background process이며, client와 daemon 사이에서의 communication을 관리</li>\\n<li>daemon: 각각의 device에서 동작하는 background process</li>\\n</ul>\\n<p>client를 시작하면, ADB server가 실행중인지 확인해서 실행중이지 않으면 server를 시작시킨다. server가 시작되면 TCP의 5037 port로 binding해서 adb client로부터의 command를 받아들이는데, 모든 client는 server와 communication 하기 위해 5037 port를 사용.</p>"}');export{P as comp,A as data};
