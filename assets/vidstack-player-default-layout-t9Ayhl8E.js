const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-BTigPj2h-BI8Oy-Nr.js","assets/app-Dp9sAfV1.js"])))=>i.map(i=>d[i]);
import{bo as h,x as Dt,y as A,m as V,bn as Mt,bY as me,aO as T,u as I,bl as ve,aM as fe,bi as he,M as g,bZ as It,U as $e,b_ as Ot,b$ as v,bh as be,C as lt,bL as _t,aQ as N,c0 as Pt,aW as ge,c1 as ye,R as xe,bk as Lt,c2 as K,z as F,c3 as Se,s as Te,ar as we,c4 as ke,bb as Ae,P as M,c5 as Ce,bs as De,_ as Me,aR as Gt,n as et,bw as Ie,c6 as Oe,c7 as _e,c8 as Pe,bW as Nt}from"./app-Dp9sAfV1.js";import{A as O,T as Le,D as Tt,x as o,s as Ge,L as Bt}from"./vidstack-CwTj4H1w-DiaEMxg6.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const l of i)(n=(s=l)._$AO)===null||n===void 0||n.call(s,t,!1),B(l,t);return!0},U=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while(s?.size===0)},Vt=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),We(t)}};function Re(e){this._$AN!==void 0?(U(this),this._$AM=e,Vt(this)):this._$AM=e}function Ee(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let l=s;l<n.length;l++)B(n[l],!1),U(n[l]);else n!=null&&(B(n,!1),U(n));else B(this,e)}const We=e=>{var t,s,n,i;e.type==Q.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Ee),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Re))};class Ft extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Vt(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(B(this,t),U(this))}setValue(t){if(Be(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class Ke extends Ft{#t=null;#s=!1;#e=null;constructor(t){super(t),this.#s=t.type===Q.ATTRIBUTE||t.type===Q.BOOLEAN_ATTRIBUTE}render(t){return t!==this.#t&&(this.disconnected(),this.#t=t,this.isConnected&&this.#n()),this.#t?this.#i(Dt(this.#t)):O}reconnected(){this.#n()}disconnected(){this.#e?.(),this.#e=null}#n(){this.#t&&(this.#e=A(this.#o.bind(this)))}#i(t){return this.#s?rt(t):t}#a(t){this.setValue(this.#i(t))}#o(){this.#a(this.#t?.())}}function a(e){return z(Ke)(h(e))}class Rt{#t;#s;elements=new Set;constructor(t,s){this.#t=t,this.#s=s}connect(){this.#n();const t=new MutationObserver(this.#e);for(const s of this.#t)t.observe(s,{childList:!0,subtree:!0});V(()=>t.disconnect()),V(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){me(t)?(s.textContent="",s.append(t)):(Tt(null,s),Tt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}#e=Mt(this.#n.bind(this));#n(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=this.#t.flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&this.#s(this.elements)}}let Qe=0,W="data-slot-id";class Et{#t;slots;constructor(t){this.#t=t,this.slots=new Rt(t,this.#e.bind(this))}connect(){this.slots.connect(),this.#e();const t=new MutationObserver(this.#s);for(const s of this.#t)t.observe(s,{childList:!0});V(()=>t.disconnect())}#s=Mt(this.#e.bind(this));#e(){for(const t of this.#t)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(W);i||s.setAttribute(W,i=++Qe+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(W)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(W,i)}}}}function Ue({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return o`<svg
    class="${"vds-icon"+(t?` ${t}`:"")}"
    viewBox="${i}"
    fill="none"
    aria-hidden="true"
  ...
  `}function Ut({tooltip:e}){const{translations:t}=u(),{remotePlaybackState:s}=v(),n=a(()=>{const l=S(t,"Google Cast"),r=Pt(s());return`${l} ${r}`}),i=d(t,"Google Cast");return o`
  ...
  `}function Ht({tooltip:e}){const{translations:t}=u(),s=d(t,"Enter Fullscreen"),n=d(t,"Exit Fullscreen");return o`
  ...
  `}function E({label:e,children:t}){return o`
  ...
  `}function D({label:e,option:t,type:s}){const{player:n}=T(),{translations:i}=u(),l=_[s],r=()=>S(i,e);function p(){De(),n.dispatchEvent(new Event("vds-font-change"))}if(t.type==="color"){let f=function(m){l.set(m.target.value),p()};return E({label:a(r),children:o`
        <input
  ...
  `}function xs(){return a(()=>{const{translations:e}=u();return o`
    ...
    `})}function Ss(){const{userPrefersAnnouncements:e,translations:t}=u(),s="Announcements";return E({label:d(t,s),children:J({label:s,storageKey:"vds-player::announcements",onChange(n){e.set(n)}})})}function Ts(){return a(()=>{const{translations:e,userPrefersKeyboardAnimations:t,noKeyboardAnimations:s}=u(),{viewType:n}=v();if(h(()=>n()!=="video"||s())())return null;const l="Keyboard Animations";return E({label:d(e,l),children:J({label:l,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(r){t.set(r)}})})})}function ws(){return a(()=>{const{noAudioGain:e,translations:t}=u(),{audioTracks:s,canSetAudioGain:n}=v();return h(()=>!(n()&&!e())&&s().length<=1)()?null:o`
 ...
 */const Hs=z(class extends ut{constructor(){super(...arguments),this.key=O}render(e,t){return this.key=e,t}update(e,[t,s]){return t!==this.key&&(Fe(e),this.key=t),s}});class zs extends dt{static props={...super.props,when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380}}function oe(){return a(()=>{const e=T(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=u();if(h(()=>t()||!s())())return null;const i=g(!1),{lastKeyboardAction:l}=e.$state;A(()=>{i.set(!!l());const m=setTimeout(()=>i.set(!1),500);return()=>{i.set(!1),window.clearTimeout(m)}});const r=h(()=>{const m=l()?.action;return m&&i()?F(m):null}),p=h(()=>`vds-kb-action${i()?"":" hidden"}`),c=h(qs),$=h(()=>{const m=js();return m?Pe(m):null});function f(){const m=$();return m?o`
    ...
    `})}function qs(){const{$state:e}=T(),t=e.lastKeyboardAction()?.action,s=e.audioGain()??1;switch(t){case"toggleMuted":return e.muted()?"0%":Ct(e.volume(),s);case"volumeUp":case"volumeDown":return Ct(e.volume(),s);default:return""}}function Ct(e,t){return`${Math.round(e*t*100)}%`}function js(){const{$state:e}=T();switch(e.lastKeyboardAction()?.action){case"togglePaused":return e.paused()?"kb-pause-icon":"kb-play-icon";case"toggleMuted":return e.muted()||e.volume()===0?"kb-mute-icon":e.volume()>=.5?"kb-volume-up-icon":"kb-volume-down-icon";case"toggleFullscreen":return`kb-fs-${e.fullscreen()?"enter":"exit"}-icon`;case"togglePictureInPicture":return`kb-pip-${e.pictureInPicture()?"enter":"exit"}-icon`;case"toggleCaptions":return e.hasCaptions()?`kb-cc-${e.textTrack()?"on":"off"}-icon`:null;case"volumeUp":return"kb-volume-up-icon";case"volumeDown":return"kb-volume-down-icon";case"seekForward":return"kb-seek-forward-icon";case"seekBackward":return"kb-seek-backward-icon";default:return null}}function Ys(){return[ct(),le(),tt(),oe(),ft(),o`<div class="vds-scrim"></div>`,o`
      <media-controls class="vds-controls">
        ${[Xs(),C(),o`<media-controls-group class="vds-controls-group"></media-controls-group>`,C(),o`
          ...
          `,o`
            <media-controls-group class="vds-controls-group">
              ${[j({tooltip:"top start"}),bt({orientation:"horizontal",tooltip:"top"}),se(),ne(),mt({tooltip:"top"}),Zs(),pt({tooltip:"top"}),Ut({tooltip:"top"}),vt(),je(),Ht({tooltip:"top end"})]}
            </media-controls-group>
          `]}
      </media-controls>
  ...
  `}function Js(){return[ct(),le(),tt(),ft(),oe(),o`<div class="vds-scrim"></div>`,o`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
          ${[pt({tooltip:"top start"}),Ut({tooltip:"bottom start"}),C(),mt({tooltip:"bottom"}),vt(),yt(),bt({orientation:"vertical",tooltip:"bottom end"})]}
        </media-controls-group>
